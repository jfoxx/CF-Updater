...
const credentialsFile = './foxxprod-service-credentials.json';

//folder path to content fragment parent
const folderPath = 'washington/services/';

//json file output from the AI agent that is placed inline with this project
const jsonFile = './washington_additional_services.json'
